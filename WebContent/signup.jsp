					...
					<div class="col-lg-7">
						...
						<!-- 2 column grid layout with text inputs for the first and last names -->
							<div class="form-outline mb-4 text-left">
								...
								<input type="email" id="Email" class="form-control" name="userEmail" value="" required/>
							...
							<div class="form-outline mb-4  text-left">
								...
								<input type="password" id="Password" class="form-control" name="userPassword" required pattern="^(?=.*\d).{6,}$" autocomplete="no"/>
								<div class="valid-feedback">Nice! You got this one!</div>
							...
							<div class="form-check d-flex flex-column justify-content-center mb-4">
								<p>New to our website?<span><a href="login.jsp" style="text-decoration:none;">Register</a></span><p>
